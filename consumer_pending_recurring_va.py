    ...
    def run(self):
        ...
        def callback(ch, method, properties, body):
            ...
            if "msgType" in data and "msgInfo" in data:
                if data['msgType'] == "consumer_pending_recurring_va":
                    payload = json.dumps({
                    ...
                    try:
                        ...
                        response = requests.request("POST", internal_url_hit+"/Pending/recurringVa", headers=headers, data=payload, timeout=30)
...
queue_name = "queue_pending_recurring_va"
max_retries = 3
