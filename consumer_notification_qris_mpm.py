    ...
    def run(self):
        ...
        def callback(ch, method, properties, body):
            ...
            if "msgType" in data and "msgInfo" in data:
                if data['msgType'] == "consumer_notification_qris_mpm":
                    payload = json.dumps({
                    ...
                    response = requests.request("POST", internal_url_hit+"/Notification/qrisMpm", headers=headers, data=payload)
                    ...
                    if response.status_code == 200:
                        ...
                        check_and_send_recovery_alert(merchant_id, "qris", self.internal_url_hit)
                    else:
...
queue_name = "queue_notification_qris_mpm"
max_retries = 3
