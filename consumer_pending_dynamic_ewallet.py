    ...
    def run(self):
        ...
        def callback(ch, method, properties, body):
            ...
            if "msgType" in data and "msgInfo" in data:
                if data['msgType'] == "consumer_pending_dynamic_ewallet":
                    payload = json.dumps({
                    ...
                    try:
                        ...
                        response = requests.request("POST", internal_url_hit+"/Pending/dynamicEwallet", headers=headers, data=payload, timeout=30)
...
queue_name = "queue_pending_dynamic_ewallet"
max_retries = 3
